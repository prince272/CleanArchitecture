...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      ...
      <br />
      <br />
      <Link {...constructContextualPath('account/change')}><a>Change Account</a></Link>
      <br />
      <br />
      <br />
      <Link {...constructContextualPath('account/password/reset')}><a>Reset Account Password</a></Link>
